pipeline {
    ...
    environment {
        DOCKER_REPO = "taskmanagement/task-management"
        DOCKER_CREDENTIAL = "dockerhub"
        JENKINS_AT_STAGING = "jenkins@staging.taskmanagement.com"
    }
    ...
    stages {
        ...
        stage("Build Docker image") {
            steps {
                sh "cp target/task-management-0.0.1-SNAPSHOT.jar docker/app.jar"
